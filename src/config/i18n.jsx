...
export const I18N = {
  // ======== Popup UI (全12种语言) ========
  popup_subtitle: {
    zh: `YouTube 双语精读助手`, en: `Bilingual Reading Assistant for YouTube`,
    zh_TW: `YouTube 雙語精讀助手`, ja: `YouTube バイリンガル精読アシスタント`,
    ko: `YouTube 이중언어 집중독서 도우미`, fr: `Assistant de lecture bilingue pour YouTube`,
    de: `Zweisprachiger Lese-Assistent für YouTube`, es: `Asistente de lectura bilingüe para YouTube`,
    pt: `Assistente de leitura bilíngue para YouTube`, it: `Assistente di lettura bilingue per YouTube`,
    ru: `Двуязычный помощник для чтения на YouTube`, vi: `Trợ lý đọc song ngữ cho YouTube`,
  },
  tab_translate: {
    zh: `翻译设置`, en: `Translation`, zh_TW: `翻譯設定`, ja: `翻訳設定`,
    ko: `번역 설정`, fr: `Traduction`, de: `Übersetzung`, es: `Traducción`,
    pt: `Tradução`, it: `Traduzione`, ru: `Перевод`, vi: `Dịch thuật`,
  },
  tab_sync: {
    zh: `数据联动`, en: `Sync`, zh_TW: `資料聯動`, ja: `データ連携`,
    ko: `데이터 연동`, fr: `Synchronisation`, de: `Synchronisation`, es: `Sincronización`,
    pt: `Sincronização`, it: `Sincronizzazione`, ru: `Синхронизация`, vi: `Đồng bộ`,
  },
  tab_about: {
    zh: `关于`, en: `About`, zh_TW: `關於`, ja: `概要`,
    ko: `정보`, fr: `À propos`, de: `Über`, es: `Acerca de`,
    pt: `Sobre`, it: `Informazioni`, ru: `О нас`, vi: `Giới thiệu`,
  },
  target_lang: {
    zh: `目标语言`, en: `Target Language`, zh_TW: `目標語言`, ja: `翻訳先言語`,
    ko: `대상 언어`, fr: `Langue cible`, de: `Zielsprache`, es: `Idioma de destino`,
    pt: `Idioma de destino`, it: `Lingua di destinazione`, ru: `Язык перевода`, vi: `Ngôn ngữ đích`,
  },
  translate_service: {
    zh: `翻译服务`, en: `Translation Service`, zh_TW: `翻譯服務`, ja: `翻訳サービス`,
    ko: `번역 서비스`, fr: `Service de traduction`, de: `Übersetzungsdienst`, es: `Servicio de traducción`,
    pt: `Serviço de tradução`, it: `Servizio di traduzione`, ru: `Служба перевода`, vi: `Dịch vụ dịch thuật`,
  },
  model_label: {
    zh: `模型`, en: `Model`, zh_TW: `模型`, ja: `モデル`,
    ko: `모델`, fr: `Modèle`, de: `Modell`, es: `Modelo`,
    pt: `Modelo`, it: `Modello`, ru: `Модель`, vi: `Mô hình`,
  },
  endpoint_label: {
    zh: `接口地址`, en: `API Endpoint`, zh_TW: `接口地址`, ja: `エンドポイント`,
    ko: `엔드포인트`, fr: `Point de terminaison`, de: `Endpunkt`, es: `Endpoint`,
    pt: `Endpoint`, it: `Endpoint`, ru: `Конечная точка`, vi: `Điểm cuối API`,
  },
  endpoint_optional: {
    zh: `可选`, en: `Optional`, zh_TW: `可選`, ja: `任意`,
    ko: `선택사항`, fr: `Facultatif`, de: `Optional`, es: `Opcional`,
    pt: `Opcional`, it: `Opzionale`, ru: `Необязательно`, vi: `Tùy chọn`,
  },
  save_and_refresh: {
    zh: `保存并刷新页面`, en: `Save & Refresh`, zh_TW: `儲存並重新整理`, ja: `保存してリロード`,
  ...
  saved: {
    ...
    pt: `Salvo`, it: `Salvato`, ru: `Сохранено`, vi: `Đã lưu`,
  },
  api_key_required: {
    zh: `请配置 API Key`, en: `API Key required`, zh_TW: `請設定 API Key`, ja: `API Keyが必要です`,
    ko: `API Key 필요`, fr: `Clé API requise`, de: `API-Schlüssel erforderlich`, es: `Se requiere API Key`,
    pt: `API Key necessária`, it: `API Key richiesta`, ru: `Требуется API Key`, vi: `Cần API Key`,
  },
  service_ready: {
    zh: `服务已就绪`, en: `Ready`, zh_TW: `服務已就緒`, ja: `準備完了`,
    ko: `준비 완료`, fr: `Prêt`, de: `Bereit`, es: `Listo`,
    pt: `Pronto`, it: `Pronto`, ru: `Готово`, vi: `Sẵn sàng`,
  },
  sync_desc: {
    zh: `绑定主站后，YouTube 上标记的生词将自动同步至单词本，并可将视频一键转化为精读文章。`, 
    en: `Connect to TheBoringEnglish to sync vocabulary from YouTube and turn any video into a deep-reading lesson with one click.`,
    zh_TW: `綁定主站後，YouTube 上標記的生詞將自動同步至單詞本，並可將影片一鍵轉化為精讀文章。`,
    ja: `メインサイトと連携すると、YouTubeでマークした単語が自動的に単語帳に同期され、動画をワンクリックで精読記事に変換できます。`,
    ko: `메인 사이트와 연동하면 YouTube에서 표시한 단어가 자동으로 단어장에 동기화되고, 동영상을 한 번에 집중독서 기사로 변환할 수 있습니다.`,
    fr: `Connectez-vous à TheBoringEnglish pour synchroniser votre vocabulaire de YouTube et transformer n'importe quelle vidéo en leçon de lecture approfondie.`,
    de: `Verbinden Sie sich mit TheBoringEnglish, um Vokabeln von YouTube zu synchronisieren und Videos mit einem Klick in Lektionen umzuwandeln.`,
    es: `Conecta TheBoringEnglish para sincronizar vocabulario de YouTube y convertir cualquier vídeo en una lección de lectura profunda.`,
    pt: `Conecte-se ao TheBoringEnglish para sincronizar vocabulário do YouTube e transformar qualquer vídeo em uma lição de leitura profunda.`,
    it: `Collega TheBoringEnglish per sincronizzare il vocabolario da YouTube e trasformare qualsiasi video in una lezione di lettura approfondita.`,
    ru: `Подключитесь к TheBoringEnglish, чтобы синхронизировать словарный запас с YouTube и превращать видео в уроки глубокого чтения.`,
    vi: `Kết nối TheBoringEnglish để đồng bộ từ vựng từ YouTube và chuyển bất kỳ video nào thành bài học đọc sâu chỉ với một cú nhấp.`,
  },
  auth_auto: {
    zh: `✨ 方式一：自动检测关联`, en: `✨ Method 1: Auto-Detect Account`,
    zh_TW: `✨ 方式一：自動偵測關聯`, ja: `✨ 方法一：自動検出連携`,
    ko: `✨ 방법 1: 자동 감지 연결`, fr: `✨ Méthode 1: Détection automatique`,
    de: `✨ Methode 1: Automatische Erkennung`, es: `✨ Método 1: Detección automática`,
    pt: `✨ Método 1: Detecção automática`, it: `✨ Metodo 1: Rilevamento automatico`,
    ru: `✨ Способ 1: Автоопределение аккаунта`, vi: `✨ Cách 1: Tự động phát hiện liên kết`,
  },
  auth_manual: {
    zh: `🔑 方式二：手动关联密钥`, en: `🔑 Method 2: Manual API Token`,
    zh_TW: `🔑 方式二：手動關聯密鑰`, ja: `🔑 方法二：手動トークン連携`,
    ko: `🔑 방법 2: 수동 API 토큰 연결`, fr: `🔑 Méthode 2: Clé API manuelle`,
    de: `🔑 Methode 2: Manuelles API-Token`, es: `🔑 Método 2: Token de API manual`,
    pt: `🔑 Método 2: Token de API manual`, it: `🔑 Metodo 2: Token API manuale`,
    ru: `🔑 Способ 2: Ввод API-токена вручную`, vi: `🔑 Cách 2: Liên kết thủ công bằng Token`,
  },
  auth_auto_desc_ok: {
    zh: `检测到已登录主站账号：`, en: `Detected an active login on the website: `,
    zh_TW: `偵測到已登入主站帳號：`, ja: `ログイン中のアカウントを検出しました: `,
    ko: `웹사이트 로그인 감지됨: `, fr: `Session active détectée sur le site : `,
    de: `Aktive Anmeldung auf der Website erkannt: `, es: `Sesión activa detectada en la web: `,
    pt: `Login ativo detectado no site: `, it: `Rilevato accesso attivo sul sito: `,
    ru: `Обнаружен активный вход на сайте: `, vi: `Phát hiện tài khoản đã đăng nhập: `,
  },
  auth_auto_desc_empty: {
    zh: `未检测到登录状态。请先在浏览器中登录官网或刷新。`, 
    en: `No active login session found on the website. Please log in first.`,
    zh_TW: `未偵測到登入狀態。請先在瀏覽器中登入官網或重新整理。`,
    ja: `ログインが検出されません。公式サイトにログインするか再ロードしてください。`,
    ko: `로그인 상태를 감지하지 못했습니다. 먼저 홈페이지에서 로그인하거나 새로고침하세요.`,
    fr: `Aucune session active trouvée. Veuillez d'abord vous connecter sur le site.`,
    de: `Keine aktive Sitzung gefunden. Bitte melden Sie sich zuerst an.`,
    es: `No se detectó sesión. Por favor inicia sesión en la web primero o recarga.`,
    pt: `Nenhuma sessão detectada. Por favor, faça login no site primeiro ou atualize.`,
    it: `Nessun accesso rilevato. Accedi prima sul sito o ricarica.`,
    ru: `Вход не выполнен. Сначала войдите на сайт или обновите страницу.`,
    vi: `Chưa phát hiện đăng nhập. Vui lòng đăng nhập trên trang web hoặc làm mới.`,
  },
  auth_auto_btn_ok: {
    zh: `一键关联此账号`, en: `Link Account Now`, zh_TW: `一鍵關聯此帳號`, ja: `アカウントを今すぐ連携`,
    ko: `이 계정 연결하기`, fr: `Associer ce compte`, de: `Konto jetzt verknüpfen`, es: `Vincular cuenta ahora`,
    pt: `Vincular conta agora`, it: `Collega account ora`, ru: `Привязать этот аккаунт`, vi: `Liên kết tài khoản này`,
  },
  auth_auto_btn_retry: {
    zh: `重新检测登录`, en: `Re-Check Login`, zh_TW: `重新偵測登入`, ja: `ログインを再検出`,
    ko: `로그인 재감지`, fr: `Réessayer la détection`, de: `Erneut prüfen`, es: `Volver a comprobar`,
    pt: `Verificar novamente`, it: `Rileva di nuovo`, ru: `Проверить снова`, vi: `Kiểm tra lại đăng nhập`,
  },
  auto_detecting: {
    zh: `✨ 检测到官网已登录，正在自动关联...`, 
    en: `✨ Login detected — linking your account automatically...`,
    zh_TW: `✨ 偵測到官網已登入，正在自動關聯...`,
    ja: `✨ 公式サイトへのログインを検出しました。自動連携中...`,
    ko: `✨ 공식 사이트 로그인 감지됨 — 자동으로 계정을 연결하는 중...`,
    fr: `✨ Connexion détectée — association automatique en cours...`,
    de: `✨ Anmeldung erkannt — Ihr Konto wird automatisch verknüpft...`,
    es: `✨ Sesión detectada — vinculando tu cuenta automáticamente...`,
    pt: `✨ Login detectado — vinculando sua conta automaticamente...`,
    it: `✨ Accesso rilevato — collegamento automatico in corso...`,
    ru: `✨ Вход обнаружен — автоматическая привязка аккаунта...`,
    vi: `✨ Phát hiện đăng nhập — đang tự động liên kết tài khoản...`,
  },
  auto_linked_success: {
    zh: `✨ 自动关联成功！欢迎回来，`, 
    en: `✨ Linked successfully! Welcome back, `,
    zh_TW: `✨ 自動關聯成功！歡迎回來，`,
    ja: `✨ 自動連携成功！おかえりなさい、`,
    ko: `✨ 자동 연동 성공! 다시 오신 것을 환영합니다, `,
    fr: `✨ Lié avec succès ! Bienvenue, `,
    de: `✨ Erfolgreich verknüpft! Willkommen zurück, `,
    es: `✨ ¡Vinculado con éxito! Bienvenido de nuevo, `,
    pt: `✨ Vinculado com sucesso! Bem-vindo de volta, `,
    it: `✨ Collegato con successo! Bentornato, `,
    ru: `✨ Успешно привязано! С возвращением, `,
    vi: `✨ Liên kết thành công! Chào mừng trở lại, `,
  },
  auto_link_fail: {
    zh: `未检测到官网登录状态，请手动输入密钥进行关联。`,
    en: `No active login found. Please enter your API Token below to connect.`,
    zh_TW: `未偵測到官網登入狀態，請手動輸入密鑰進行關聯。`,
    ja: `公式サイトへのログインが見つかりません。下記にAPIトークンを入力してください。`,
    ko: `활성 로그인을 찾을 수 없습니다. 아래에 API 토큰을 입력하여 연결하세요.`,
    fr: `Aucune connexion active trouvée. Veuillez saisir votre jeton API ci-dessous.`,
    de: `Kein aktives Login gefunden. Bitte geben Sie unten Ihr API-Token ein.`,
    es: `No se encontró sesión activa. Introduce tu Token de API abajo para conectar.`,
    pt: `Nenhum login ativo encontrado. Digite seu Token de API abaixo para conectar.`,
    it: `Nessun accesso attivo trovato. Inserisci il tuo token API qui sotto.`,
    ru: `Активный вход не найден. Введите токен API ниже для подключения.`,
    vi: `Không tìm thấy phiên đăng nhập. Vui lòng nhập API Token bên dưới để kết nối.`,
  },
  connected_to: {
    zh: `已连接至 TheBoringEnglish`, en: `Connected to TheBoringEnglish`,
    zh_TW: `已連接至 TheBoringEnglish`, ja: `TheBoringEnglishに接続済み`,
    ko: `TheBoringEnglish에 연결됨`, fr: `Connecté à TheBoringEnglish`,
    de: `Mit TheBoringEnglish verbunden`, es: `Conectado a TheBoringEnglish`,
    pt: `Conectado ao TheBoringEnglish`, it: `Connesso a TheBoringEnglish`,
    ru: `Подключено к TheBoringEnglish`, vi: `Đã kết nối với TheBoringEnglish`,
  },
  server_label: {
    zh: `服务器`, en: `Server`, zh_TW: `伺服器`, ja: `サーバー`,
    ko: `서버`, fr: `Serveur`, de: `Server`, es: `Servidor`,
    pt: `Servidor`, it: `Server`, ru: `Сервер`, vi: `Máy chủ`,
  },
  user_label: {
    zh: `用户`, en: `User`, zh_TW: `使用者`, ja: `ユーザー`,
    ko: `사용자`, fr: `Utilisateur`, de: `Benutzer`, es: `Usuario`,
    pt: `Usuário`, it: `Utente`, ru: `Пользователь`, vi: `Người dùng`,
  },
  disconnect: {
    zh: `断开连接`, en: `Disconnect`, zh_TW: `斷開連線`, ja: `切断`,
    ko: `연결 해제`, fr: `Déconnecter`, de: `Trennen`, es: `Desconectar`,
    pt: `Desconectar`, it: `Disconnetti`, ru: `Отключить`, vi: `Ngắt kết nối`,
  },
  server_url_label: {
    zh: `主站地址`, en: `Site URL`, zh_TW: `主站地址`, ja: `サイトURL`,
    ko: `사이트 URL`, fr: `URL du site`, de: `Website-URL`, es: `URL del sitio`,
    pt: `URL do site`, it: `URL del sito`, ru: `URL сайта`, vi: `URL trang web`,
  },
  api_token_label: {
    zh: `API Token（账户密钥）`, en: `API Token`, zh_TW: `API Token（帳戶金鑰）`, ja: `APIトークン`,
    ko: `API 토큰`, fr: `Token API`, de: `API-Token`, es: `Token API`,
    pt: `Token API`, it: `Token API`, ru: `API-токен`, vi: `Token API`,
  },
  api_token_hint: {
    zh: `在主站「个人设置」中获取密钥并粘贴至此`, 
    en: `Find your token in Profile Settings on the website`,
    zh_TW: `在主站「個人設定」中取得金鑰並貼上`,
    ja: `公式サイトの「プロフィール設定」でトークンを取得してください`,
    ko: `웹사이트의 프로필 설정에서 토큰을 찾으세요`,
    fr: `Trouvez votre token dans les paramètres de profil du site`,
    de: `Token in den Profileinstellungen der Website finden`,
    es: `Encuentra tu token en Configuración de perfil del sitio web`,
    pt: `Encontre seu token nas configurações de perfil do site`,
    it: `Trova il tuo token nelle impostazioni del profilo del sito`,
    ru: `Найдите токен в настройках профиля на сайте`,
    vi: `Tìm token trong Cài đặt hồ sơ trên trang web`,
  },
  verifying: {
    zh: `正在验证...`, en: `Verifying...`, zh_TW: `正在驗證...`, ja: `確認中...`,
    ko: `인증 중...`, fr: `Vérification...`, de: `Wird überprüft...`, es: `Verificando...`,
    pt: `Verificando...`, it: `Verifica in corso...`, ru: `Проверка...`, vi: `Đang xác minh...`,
  },
  connect_btn: {
    zh: `关联账户`, en: `Connect Account`, zh_TW: `關聯帳戶`, ja: `アカウントを連携`,
    ko: `계정 연결`, fr: `Connecter le compte`, de: `Konto verbinden`, es: `Conectar cuenta`,
    pt: `Conectar conta`, it: `Collega account`, ru: `Подключить аккаунт`, vi: `Kết nối tài khoản`,
  },
  fill_all_fields: {
    zh: `请填写完整的服务器地址及 API Token`, en: `Please provide the server URL and API Token`,
    zh_TW: `請填寫完整的伺服器地址及 API Token`, ja: `サーバーURLとAPIトークンを入力してください`,
    ko: `서버 URL과 API 토큰을 입력하세요`, fr: `Veuillez fournir l'URL du serveur et le Token API`,
    de: `Bitte Server-URL und API-Token angeben`, es: `Por favor proporciona la URL del servidor y el Token API`,
    pt: `Por favor, forneça a URL do servidor e o Token API`, it: `Fornisci l'URL del server e il Token API`,
    ru: `Укажите URL сервера и API-токен`, vi: `Vui lòng cung cấp URL máy chủ và Token API`,
  },
  connect_success: {
    zh: `连接成功！已登录为 `, en: `Connected! Signed in as `,
    zh_TW: `連接成功！已登入為 `, ja: `接続成功！ログイン中: `,
    ko: `연결 성공! 로그인됨: `, fr: `Connecté ! Connecté en tant que `,
    de: `Verbunden! Angemeldet als `, es: `¡Conectado! Sesión iniciada como `,
    pt: `Conectado! Conectado como `, it: `Connesso! Accesso come `,
    ru: `Подключено! Вход выполнен как `, vi: `Đã kết nối! Đăng nhập với tên `,
  },
  connect_fail: {
    zh: `验证失败，请检查密钥是否正确或已过期`, en: `Verification failed. Please check your token.`,
    zh_TW: `驗證失敗，請檢查金鑰是否正確或已過期`, ja: `認証に失敗しました。トークンを確認してください。`,
    ko: `인증 실패. 토큰을 확인하세요.`, fr: `Échec de la vérification. Veuillez vérifier votre token.`,
    de: `Überprüfung fehlgeschlagen. Bitte Token prüfen.`, es: `Verificación fallida. Comprueba tu token.`,
    pt: `Falha na verificação. Verifique seu token.`, it: `Verifica fallita. Controlla il tuo token.`,
    ru: `Ошибка проверки. Проверьте токен.`, vi: `Xác minh thất bại. Vui lòng kiểm tra token của bạn.`,
  },
  tip_builtin_engines: {
    zh: `💡 内置免费微软与谷歌引擎，无需配置即可立即使用。`,
    en: `💡 Built-in Microsoft & Google engines work right out of the box — no setup needed.`,
    zh_TW: `💡 內建免費微軟與谷歌引擎，無需設定即可立即使用。`,
    ja: `💡 Microsoft・Google無料エンジン内蔵、設定不要ですぐに使えます。`,
    ko: `💡 Microsoft & Google 무료 엔진이 내장되어 있어 별도 설정 없이 바로 사용 가능합니다.`,
    fr: `💡 Les moteurs Microsoft & Google intégrés fonctionnent sans configuration.`,
    de: `💡 Integrierte Microsoft & Google Engines funktionieren ohne Einrichtung.`,
    es: `💡 Los motores Microsoft y Google integrados funcionan sin configuración previa.`,
    pt: `💡 Os motores Microsoft e Google integrados funcionam sem configuração.`,
    it: `💡 I motori Microsoft e Google integrati funzionano senza configurazione.`,
    ru: `💡 Встроенные движки Microsoft и Google работают без настройки.`,
    vi: `💡 Công cụ Microsoft & Google tích hợp sẵn, không cần cấu hình.`,
  },
  about_desc: {
    zh: `搭配 TheBoringEnglish 主站，可实现生词一键同步、视频精读文章一键生成等高级功能。点击上方链接开始沉浸式精读之旅！`,
    en: `Pair with TheBoringEnglish to unlock one-click word sync, instant video-to-article generation, and a beautiful reading space crafted for deep learning. Click the link above to begin.`,
    zh_TW: `搭配 TheBoringEnglish 主站，可實現生詞一鍵同步、影片精讀文章一鍵生成等高級功能。點擊上方連結開始沉浸式精讀之旅！`,
    ja: `TheBoringEnglish公式サイトと組み合わせることで、単語の同期、動画から精読記事への変換などの高度な機能が使えます。上記のリンクをクリックして始めましょう！`,
    ko: `TheBoringEnglish 메인 사이트와 함께 사용하면 단어 동기화, 동영상 기사 변환 등 고급 기능을 활용할 수 있습니다. 위 링크를 클릭해 시작하세요!`,
    fr: `Associez à TheBoringEnglish pour débloquer la synchronisation de mots, la génération d'articles et plus encore. Cliquez sur le lien ci-dessus pour commencer !`,
    de: `Mit TheBoringEnglish schalten Sie Wort-Synchronisation, Artikel-Generierung und mehr frei. Klicken Sie oben, um zu beginnen!`,
    es: `Combina con TheBoringEnglish para sincronizar palabras, generar artículos de vídeos y más. ¡Haz clic arriba para empezar!`,
    pt: `Combine com TheBoringEnglish para sincronizar palavras, gerar artigos de vídeos e mais. Clique acima para começar!`,
    it: `Abbina a TheBoringEnglish per sincronizzare parole, generare articoli dai video e molto altro. Clicca sopra per iniziare!`,
    ru: `Используйте с TheBoringEnglish для синхронизации слов, создания статей из видео и многого другого. Нажмите ссылку выше, чтобы начать!`,
    vi: `Kết hợp với TheBoringEnglish để đồng bộ từ vựng, tạo bài viết từ video và nhiều hơn. Nhấp vào liên kết trên để bắt đầu!`,
  },
  version_label: {
    zh: `版本`, en: `Version`, zh_TW: `版本`, ja: `バージョン`,
    ko: `버전`, fr: `Version`, de: `Version`, es: `Versión`,
    pt: `Versão`, it: `Versione`, ru: `Версия`, vi: `Phiên bản`,
  },
  author_label: {
    zh: `作者`, en: `Author`, zh_TW: `作者`, ja: `作者`,
    ko: `작성자`, fr: `Auteur`, de: `Autor`, es: `Autor`,
    pt: `Autor`, it: `Autore`, ru: `Автор`, vi: `Tác giả`,
  },
  website_label: {
    zh: `官方网站`, en: `Website`, zh_TW: `官方網站`, ja: `公式サイト`,
    ko: `공식 웹사이트`, fr: `Site web`, de: `Website`, es: `Sitio web`,
    pt: `Site`, it: `Sito web`, ru: `Сайт`, vi: `Trang web`,
  },
  // ======== End Popup UI ========
  import_subtitle: {
    zh: `Import`,
  ...
  no_en_subtitle: {
    zh: `没有检测到英文字幕（官方或自动生成），无法导入。`,
    en: `No English subtitles (official or auto-generated) detected, import failed.`,
    zh_TW: `沒有檢測到英文字幕（官方或自動產生），無法匯入。`,
  ...
  import_asr_confirm: {
    ...
    zh_TW: `此影片目前使用的是自動產生的字幕。自動產生的字幕在匯入後會經過 AI 語義校對與斷句，可能會和影片時間軸無法完美對應（存在幾秒的偏差或合併）。是否確認繼續匯入？`,
    ja: `この動画は現在自動生成された字幕を使用しています。インポートされた字幕はAIによって校正およびセグメント化されるため、動画のタイムラインと完全に一致しない場合があります（数秒のズレや文の結合が発生する可能性があります）。インポートを続行しますか？`,
    ko: `이 동영상은 현재 자동 생성된 자막을 사용하고 있습니다. 가져온 자막은 AI에 의해 교정 및 세그먼트화되므로 동영상 타임라인과 완벽하게 일치하지 않을 수 있습니다(몇 초의 편차 또는 문장 병합이 발생할 수 있음). 계속 가져오시겠습니까?`,
  },
  app_name: {
    zh: `TheBoringEnglish`,
    en: `TheBoringEnglish`,
    zh_TW: `TheBoringEnglish`,
    ja: `TheBoringEnglish`,
    ko: `TheBoringEnglish`,
  },
  translate: {
  ...
  about_theboringenglish: {
    zh: `关于 TheBoringEnglish`,
    en: `About TheBoringEnglish`,
    zh_TW: `關於 TheBoringEnglish`,
    ja: `TheBoringEnglish について`,
    ko: `TheBoringEnglish 정보`,
  },
  app_subtitle: {
    zh: `YouTube 双语字幕增强`,
    en: `YouTube Bilingual Subtitles Enhancement`,
    zh_TW: `YouTube 雙語字幕增強`,
    ja: `YouTube 2ヶ国語字幕の強化`,
    ko: `YouTube 이중 언어 자막 강화`,
  },
  version: {
    zh: `版本`,
    en: `Version`,
  ...
  feature_immersive: {
    zh: `📺 沉浸式双语字幕`,
    en: `📺 Immersive Bilingual Subtitles`,
    zh_TW: `📺 沉浸式雙語字幕`,
    ja: `📺 没入型2ヶ国語字幕`,
    ko: `📺 몰입형 이중 언어 자막`,
  },
  ...
  feature_export: {
    zh: `📤 多格式生词导出`,
    en: `📤 Multi-format Vocabulary Export`,
    zh_TW: `📤 多格式生字匯出`,
    ja: `📤 各種形式での単語出力`,
    ko: `📤 다양한 형식의 단어 내보내기`,
  },
  ...
  sub_translate_to: {
    zh: `字幕翻译目标语言`,
    en: `Subtitle translation target language`,
    zh_TW: `字幕翻譯目標語言`,
    ja: `字幕翻訳のターゲット言語`,
    ko: `자막 번역 대상 언어`,
  },
  ...
  ai_segmentation_desc: {
    zh: `使用 AI 对 YouTube 自动生成的逐词字幕进行智能断句和翻译，获得更自然流畅的双语字幕体验。`,
    en: `Use AI to intelligently segment and translate YouTube's auto-generated word-by-word subtitles for a more natural and fluid bilingual experience.`,
    zh_TW: `使用 AI 對 YouTube 自動生成的逐詞字幕进行智能斷句和翻譯，獲得更自然流暢的雙語字幕體驗。`,
    ja: `AIを使用してYouTubeの自動生成された単語ごとの字幕をインテリジェントにセグメント化して翻訳し、より自然で流暢な2ヶ国語体験を実現します。`,
    ko: `AI를 사용하여 YouTube의 자동 생성된 단어별 자막을 지능적으로 분할하고 번역하여 보다 자연스럽고 매끄러운 이중 언어 경험을 제공합니다.`,
  },
  enable_ai_segmentation: {
    zh: `启用 AI 断句`,
    en: `Enable AI Segmentation`,
    zh_TW: `啟用 AI 斷句`,
    ja: `AI 文節区切りを有効にする`,
    ko: `AI 문장 분할 활성화`,
  },
  ...
  ai_not_selected: {
    zh: `未选择 (请选择一个 AI 引擎)`,
    en: `Not selected (Please choose an AI engine)`,
    zh_TW: `未選擇 (請選擇一個 AI 引擎)`,
    ja: `未選択 (AI エンジンを選択してください)`,
    ko: `선택되지 않음 (AI 엔진을 선택하십시오)`,
  },
  ai_select_warn: {
    zh: `⚠️ 请选择一个 AI 供应商来启用智能断句功能`,
    en: `⚠️ Please select an AI provider to enable smart segmentation`,
    zh_TW: `⚠️ 請選擇一個 AI 供應商來啟用智能斷句功能`,
    ja: `⚠️ スマートセグメンテーションを有効にするには、AI プロバイダーを選択してください`,
    ko: `⚠️ 스마트 문장 분할을 활성화하려면 AI 공급업체를 선택하십시오`,
  },
  config_for: {
    zh: `配置`,
    en: `Configuration`,
  ...
  sync_warn: {
    zh: `涉及隐私数据的同步请谨慎选择第三方同步服务，建议自行搭建 theboringenglish-worker 或 WebDAV 服务。`,
    en: `When synchronizing data that involves privacy, please be cautious about choosing third-party sync services. It is recommended to set up your own sync service using theboringenglish-worker or WebDAV.`,
    zh_TW: `同步涉及隱私資料時，請謹慎選擇第三方同步服務；建議自建 theboringenglish-worker 或 WebDAV 服務。`,
    ja: `プライバシーに関わるデータを同期する場合、サードパーティの同期サービスは慎重に選択してください。theboringenglish-worker や WebDAV サービスを自己ホスティングすることをお勧めします。`,
    ko: `개인정보가 포함된 데이터를 동기화할 경우, 타사 동기화 서비스 선택에 신중을 기하십시오. 자체 theboringenglish-worker 또는 WebDAV 서비스를 구축하는 것을 권장합니다.`,
  },
  sync_warn_2: {
  ...
  about_sync_api: {
    zh: `自建theboringenglish-worker数据同步服务`,
    en: `Self-hosting a TheBoringEnglish-worker data sync service`,
    zh_TW: `自建 theboringenglish-worker 資料同步服務`,
    ja: `TheBoringEnglish-worker データ同期サービスをセルフホストする`,
    ko: `TheBoringEnglish-worker 데이터 동기화 서비스 자체 호스팅`,
  },
  about_api: {
  ...
  inject_js_helper: {
    zh: `预加载时注入，一个页面仅运行一次。内置全局对象 TheBoringEnglish: {
      apiTranslate,
      apiDectect,
      apiSetting,
      apisMap,
    ...
    en: `Injected during preload, runs only once per page. Built-in global object TheBoringEnglish: {
      apiTranslate,
      apiDectect,
      apiSetting,
      apisMap,
    ...
    zh_TW: `預先載入時注入，一個頁面僅運行一次。內建全域物件 TheBoringEnglish: {
      apiTranslate,
      apiDectect,
      apiSetting,
      apisMap,
    ...
    ja: `プリロード時に注入され、ページごとに1回だけ実行されます。組み込みグローバルオブジェクト TheBoringEnglish: {
      apiTranslate,
      apiDectect,
      apiSetting,
      apisMap,
    ...
    ko: `미리 로드 시 주입되며 페이지당 한 번만 실행됩니다. 내장 전역 객체 TheBoringEnglish: {
      apiTranslate,
      apiDectect,
      apiSetting,
      apisMap,
  ...
  fixer_function_helper: {
    zh: `1、br是将<br>换行替换成<p "theboringenglish-p">。2、bn是将\\n换行替换成<p "theboringenglish-p">。3、brToDiv和bnToDiv是替换成<div class="theboringenglish-p">。`,
    en: `1. br replaces <br> line breaks with <p "theboringenglish-p">. 2. bn replaces \\n newline with <p "theboringenglish-p">. 3. brToDiv and bnToDiv are replaced with <div class="theboringenglish-p">.`,
    zh_TW: `1. br 會將 <br> 換行替換為 <p "theboringenglish-p">。2. bn 會將 \\n 換行替換為 <p "theboringenglish-p">。3. brToDiv 與 bnToDiv 會替換為 <div class="theboringenglish-p">。`,
    ja: `1. br は <br> 改行を <p "theboringenglish-p"> に置き換えます。 2. bn は \\n 改行を <p "theboringenglish-p"> に置き換えます。 3. brToDiv と bnToDiv は <div class="theboringenglish-p"> に置き換えます。`,
    ko: `1. br은 <br> 줄바꿈을 <p "theboringenglish-p">로 대체합니다. 2. bn은 \\n 줄바꿈을 <p "theboringenglish-p">로 대체합니다. 3. brToDiv 및 bnToDiv는 <div class="theboringenglish-p">로 대체됩니다.`,
  },
  import: {
    zh: `导入`,
    en: `Import`,
  ...
  error_sync_setting: {
    zh: `您的同步类型必须为“THEBORINGENGLISH-Worker”，且需填写完整`,
    en: `Your sync type must be "THEBORINGENGLISH-Worker" and must be filled in completely`,
    zh_TW: `您的同步型態必須為「THEBORINGENGLISH-Worker」，且需填寫完整。`,
    ja: `同期タイプは「THEBORINGENGLISH-Worker」である必要があり、すべて入力する必要があります。`,
    ko: `동기화 유형은 "THEBORINGENGLISH-Worker"여야 하며, 모든 항목을 빠짐없이 입력해야 합니다.`,
  },
  click_test: {
    zh: `点击测试`,
    en: `Click Test`,
  ...
  reg_niutrans: {
    zh: `获取小牛翻译密钥【TheBoringEnglish专属新用户注册赠送300万字符】`,
    en: `Get NiuTrans APIKey [TheBoringEnglish Exclusive New User Registration Free 3 Million Characters]`,
    zh_TW: `取得小牛翻譯金鑰【TheBoringEnglish專屬新用戶註冊贈送 300 萬字元】`,
    ja: `NiuTrans APIキーを取得 [TheBoringEnglish 専用 新規ユーザー登録で300万文字無料]`,
    ko: `NiuTrans API 키 받기 [TheBoringEnglish 번역기 신규 사용자 등록 시 300만 자 무료 제공]`,
  },
  trigger_mode: {
    zh: `触发方式`,
    en: `Trigger Mode`,
  ...
  subtitle_data_is_ready: {
    zh: `字幕数据已准备就绪，请点击TheBoringEnglish按钮加载`,
    en: `The subtitle data is ready, please click the TheBoringEnglish button to load it`,
    zh_TW: `字幕資料已準備就緒，請點擊TheBoringEnglish按鈕加載`,
    ja: `字幕データの準備ができました。TheBoringEnglishボタンをクリックして読み込んでください`,
    ko: `자막 데이터가 준비되었습니다. TheBoringEnglish 버튼을 클릭하여 로드하세요`,
  },
...
export const newI18n = (lang) => (key) => I18N[key]?.[lang] || I18N[key]?.["en"] || I18N[key]?.["zh"] || "";
